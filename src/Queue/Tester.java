...
public class Tester{
  public static void main (String[]args){
    ...
    System.out.println("Distance of '1' from the front: "+queue.search(1));
    try{
    ...
    System.out.println("size: "+queue.size());
    System.out.println("isEmpty: "+queue.isEmpty());
    System.out.println("Distance of '9' from the front: "+queue.search(9));
    ...
    try{
      ...
      System.err.println("Queue Empty\n"+e);
    	...
    	System.out.println("Enque: 89");
        queue.enqueue(89);
    	System.out.println("Enque: 63");
        queue.enqueue(63);
    	System.out.println("Enque: 45");
        queue.enqueue(45);
      }catch(QueueOverflowException e){
        System.err.println("Queue Empty\n"+e);
      }
